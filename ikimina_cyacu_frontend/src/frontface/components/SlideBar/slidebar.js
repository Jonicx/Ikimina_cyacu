		...
		<>
			<Col lg={3} className='DarkPanel_Directions'>
				...
				<Col lg={12} md={12} sm={12} xs={12}>
					...
					<Link to={reverse(RoutesName.home)} className='btn btn-outline-default text-center text-bold  py-0 mt-3'>
					...
					<p className='text-left text-bold text-center'>
						<Link to={reverse(RoutesName.pages.register)} className='btn btn-outline-default text-center text-bold  py-0 mt-3'
						>
